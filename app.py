...
model = joblib.load("std_mark_predictor_model.pkl") 
...
def predict():
    ...
    if input_features[0] <0 or input_features[0]>24:
        return render_template('index.html', prediction_text='Plz enter a vaild hour between 1 to 24')
        
    output = model.predict([features_value])[0][0].round(2)
 # input and predict values store in df then save in csv file
